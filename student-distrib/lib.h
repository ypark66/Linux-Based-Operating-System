...
/* Delete the current displayed character (replace it with ' '). */
void clear_char();
...
/* 
 * Creates a vertical scrolling effect by copying all of the video memory
 * rows into the previous row and "blanking" the last one. 
 */
void scroll();
/***** END MY FUNCTIONS *****/
